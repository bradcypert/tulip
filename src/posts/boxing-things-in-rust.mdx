...
author: "Brad Cypert"
thumbnail: ../images/rusted-lock.jpg
excerpt: ""
type: post
category:
  - rust
...
<HeadsUp title="Stack? Heap? Whaaa?">
  If the idea of the Stack and/or Heap is confusing -- no worries! Memory management is a very complicated topic as its fundamental to how computers operate. Most programming languages help abstract these concerns from you, however there are a few that do not. Rust is one of those languages. If you don't feel comfortable with the Stack and Heap yet, you can learn more about them as you go! Don't let it hold you up!
</HeadsUp>
