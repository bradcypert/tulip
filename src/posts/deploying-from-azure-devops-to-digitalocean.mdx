...
<div class="wp-block-image">
  <figure class="aligncenter size-full">
    ![DigitalOcean's choose a plan options](../images/Screenshot_2020-02-19-DigitalOcean-Create-Droplets2.png)
...
![Click New Service Connection](../images/Screenshot_2020-02-19-Settings--Service-connections-Porios-Settings.png)
Click on “New Service Connection” in the top right.

![Search for SSH and select the SSH option](../images/Screenshot_2020-02-19-Settings--Service-connections-Porios-Settings1.png)

In the search box, type “SSH” and click on the SSH option below. We’ll now fill our
our SSH service connection details.

![New SSH service connection form](../images/Screenshot_2020-02-19-Settings--Service-connections-Porios-Settings2.png)
...
![Settings for Copy Files over SSH](../images/Screenshot_2020-02-19-Deployment-groups-Azure-DevOps-Services4-1.png)
