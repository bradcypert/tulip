...
type: post
id: 3581
thumbnail: ../../uploads/2020/09/Untitled.png
category:
  - dart
tag:
  - dart
...
We’re going to add[ redirecting constructor](https://www.bradcypert.com/the-many-constructors-of-dart/) to our model here. This allows us to maintain our primary constructor, but specify a new constructor specifically for dealing with `dynamic` json types of data.
