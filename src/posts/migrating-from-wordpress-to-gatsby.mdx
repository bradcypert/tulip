...
I chose the name Tulip because I like project names, and I think it embodies the goal of my
...
I also decided to use [Semantic UI](https://semantic-ui.com/) for this project. This was actually a pain to setup, and I'll document
that on the blog at some point.

In my Gatsby Node, I setup three different additional page creation strategies. I created one to list
