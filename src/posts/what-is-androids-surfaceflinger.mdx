...
type: post
id: 1018
thumbnail: ../../uploads/2019/03/android-phone-blur-cellular-telephone-454699.jpg
category:
  - Android
tag:
  - android
...
<div class="wp-block-image">
  <figure class="aligncenter">
    ![](http://www.bradcypert.com/wp-content/uploads/2019/03/3parts.jpg)
    <figcaption>
      The Status Bar, App Content and Navigation Bar sections highlighted in
      [Brad Cypert’s Image2Text
      application](https://play.google.com/store/apps/details?id=com.bradcypert.image2text&hl=en_US).
    </figcaption>
  </figure>
</div>
...
<div class="wp-block-image">
  <figure class="aligncenter">
    ![](../../uploads/2019/03/ape_fwk_graphics.png)
    <figcaption>
      Android Graphic’s Components, courtesy of [The Android Source
      Documentation for Graphics.](https://source.android.com/devices/graphics)
    </figcaption>
  </figure>
</div>
...
<span class="bctt-click-to-tweet">
  <span class="bctt-ctt-text">
    [ To avoid this, it's imperative that the SurfaceFlinger only updates
    contents between refreshes.
    ](https://twitter.com/intent/tweet?url&text=%20To%20avoid%20this%2C%20it%27s%20imperative%20that%20the%20SurfaceFlinger%20only%20updates%20contents%20between%20refreshes.&via=bradcypert&related=bradcypert)
  </span>
  [Click To Tweet](https://twitter.com/intent/tweet?url&text=%20To%20avoid%20this%2C%20it%27s%20imperative%20that%20the%20SurfaceFlinger%20only%20updates%20contents%20between%20refreshes.&via=bradcypert&related=bradcypert)
</span>
...
Hopefully you’ve found this post helpful! If you’d like to learn more about Android Development, you can [find more of my Android posts here](https://www.bradcypert.com/tag/android/)!
