...
type: post
id: 1000
thumbnail: ../../uploads/2019/03/arm-wrestling-bar-bet-4417.jpg
category:
  - Kotlin
  - Scala
tag:
...
Also, I regularly blog about both [Kotlin](https://www.bradcypert.com/tag/kotlin/) and [Scala](https://www.bradcypert.com/tag/scala/) on BradCypert.com!
...
![](https://i2.wp.com/www.bradcypert.com/wp-content/uploads/2019/03/Screen-Shot-2019-03-04-at-10.52.00-AM.png?fit=640%2C340&ssl=1)
...
![](https://i0.wp.com/www.bradcypert.com/wp-content/uploads/2019/03/Screen-Shot-2019-03-04-at-10.51.45-AM.png?fit=640%2C339&ssl=1)
...
[**Ktor**](https://ktor.io/) is a framework for building asynchronous servers and clients in connected systems using Kotlin. You can use Ktor to build an API or a simple rest client. The documentation for Ktor is pretty great, and the community seems to be producing a fair amount of tutorials for it too. In fact, I’ve got a [few blog posts on using Ktor here](https://www.bradcypert.com/tag/ktor/). Ktor gives you full control over your API at the application level and supports third party plugins to enable things like Type-Safe routing, JWT, and Status Pages. You can enable what you need and remove what you don’t.
...
Regardless of whether you choose Kotlin or Scala for your next project, I’d be thrilled to help you on that journey. You can [find my tutorials and blog posts on Kotlin here](https://www.bradcypert.com/tag/kotlin) and [my Scala tutorials and blog posts here](https://www.bradcypert.com/tag/scala)! If you’ve found this comparison of Kotlin Vs. Scala useful, let me know below!
