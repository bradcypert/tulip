...
![A Trie with nodes that create the word "Propane"](../images/propane.png)

Simple enough, right? Let’s add “butane” (the devil’s gas) to the Trie as well!

![A Trie with nodes that create the words "Propane" and "Butane"](../images/propanebutane.png)
...
![A Trie with nodes that create the words "Propane", "Butane", "Bobby", and "Protein"](../images/fulltrie-2.png)
