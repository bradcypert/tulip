...
type: post
id: 872
thumbnail: ../../uploads/2019/02/blur-business-close-up-270557.jpg
category:
  - PHP
tag:
  - PHP
...
If you’re interested in learning more about PHP, [you can find more of my PHP related posts here](https://www.bradcypert.com/tag/php/). Additionally, you can find more information about arrays in the [PHP manual](http://php.net/manual/en/language.types.array.php).
