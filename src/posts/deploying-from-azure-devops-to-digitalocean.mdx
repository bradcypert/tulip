...
type: post
id: 2759
thumbnail: ../images/beach-foam-landscape-nature-533923.jpg
category:
  - DevOps
tag:
  - azure
...
<div class="wp-block-image">
  ...
  resource.](../images/Screenshot_2020-02-19-DigitalOcean-brad-cypert-project.png)
</div>
...
<div class="wp-block-image">
  ![](../images/Screenshot_2020-02-19-DigitalOcean-Create-Droplets1.png)
</div>
...
<div class="wp-block-image">
  <figure class="aligncenter size-full">
    ...
    options](../images/Screenshot_2020-02-19-DigitalOcean-Create-Droplets2.png)
...
![Don't forget to setup your SSH keys!](../images/Screenshot_2020-02-19-DigitalOcean-Create-Droplets3.png)Finally, create that droplet and give it a moment to build! You’ll be presented with an IP address. Copy that to your clipboard, as we’ll use it in just a moment.
...
<div class="wp-block-image">
  ![](../images/Screenshot_2020-02-19-Pipelines-Recent.png)
</div>
...
<figure class="wp-block-image size-full">
  ![Azure DevOps new
  pipeline](../images/Screenshot_2020-02-19-New-pipeline-Pipelines1.png)
  <figcaption>
...
![](../images/Screenshot_2020-02-19-Porios-CI-Azure-DevOps-Services1.png)Our `go build` step in our pipeline creates a `main` file in our `server` directory. I’m telling Azure to pick that up as the artifact and name it `go-server` so we can easily find it when we create our release pipeline later.
...
<div class="wp-block-image">
  ![](../images/Screenshot_2020-02-19-Releases-Pipelines.png)
</div>
...
<div class="wp-block-image">
  ![](../images/Screenshot_2020-02-19-New-release-pipeline-Pipelines.png)
</div>
...
<div class="wp-block-image">![](../images/artifacts.jpg)</div>You’ll need to
...
<div class="wp-block-image">
  ![](../images/Screenshot_2020-02-19-Deployment-groups-Azure-DevOps-Services.png)
</div>
...
<div class="wp-block-image">
  ![](../images/Screenshot_2020-02-19-Deployment-groups-Azure-DevOps-Services3.png)
</div>
You’ll want to setup that task to do something like the following:

<div class="wp-block-image">
  ![](../images/Screenshot_2020-02-19-Deployment-groups-Azure-DevOps-Services4-1.png)
</div>
...
<div class="wp-block-image">
  <figure class="aligncenter size-large">
    ![Click New Service
    Connection](https://i1.wp.com/www.bradcypert.com/../images/Screenshot_2020-02-19-Settings-%C2%B7-Service-connections-Porios-Settings.png?fit=640%2C53&ssl=1)
  </figure>
</div>
...
<div class="wp-block-image">
  ...
  option](../images/Screenshot_2020-02-19-Settings-%C2%B7-Service-connections-Porios-Settings1.png)
</div>
...
<div class="wp-block-image">
  ...
  form](../images/Screenshot_2020-02-19-Settings-%C2%B7-Service-connections-Porios-Settings2.png)
</div>
...
<div class="wp-block-image">
  ...
  SSH.](../images/Screenshot_2020-02-19-Deployment-groups-Azure-DevOps-Services4-1.png)
</div>
...
![Run shell commands on remote machine](../images/Screenshot_2020-02-19-Deployment-groups-Azure-DevOps-Services5.png)```
...
![Three task plan for stopping a running service, replacing its binary, and starting it again.](../images/Screenshot_2020-02-19-Deployment-groups-Azure-DevOps-Services6.png)Conclusion
